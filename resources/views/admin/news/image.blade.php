...
<div class="row">
    <div class="col-6">
        <div class="card">
            <div class="card-header">
                <h4 class="card-title"><a href="{{route('admin.news.index')}}">Berita</a> > List Image Berita</h4>
            </div>
            <div class="card-body">
                <table class="table table-striped">
                    ...
                    <tr>
                        ...
                        <td>
                            <a href="javascript:void(0)" type="button" class="btn btn-danger btn-sm open-delete-modal" data-bs-toggle="modal" data-bs-target="#deleteModal" data-id="{{ $value->id }}" data-news_id="{{$news_id}}">
    ...
    <div class="col-6">
        <div class="card">
            <div class="card-header">
                <h4 class="card-title">Image Berita</h4>
            </div>
            <div class="card-body">
...
<script type="text/javascript">
    $(document).on("click", ".open-delete-modal", function () {
        ...
        $(".modal-body #news_id").val(news_id);
    })
</script>
@endsection